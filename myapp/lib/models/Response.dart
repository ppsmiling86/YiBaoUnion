...
class ProductEntity extends Object {
	...
	ProductEntity(this.sold_progress, this.total_supply, this.price, this.finished_progress, this.limit_per_user,this.score_per_unithour,this.current_user_limit, this.left);
